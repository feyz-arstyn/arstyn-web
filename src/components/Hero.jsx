...
export default function Hero() {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 mx-auto w-full h-screen px-6 py-24 md:py-36">
                <motion.div
                ...
                >
                    ...
                    <p className="mt-5 text-white/85 text-lg md:text-xl">
                        Arstyn crafts reliable, maintainable web
                        products—polished frontends, robust APIs, and thoughtful
                        UX—delivered with focus and care.
                    </p>
