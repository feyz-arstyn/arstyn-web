...
export const metadata = {
    ...
    description:
        "Clean, modern web experiences with real performance. We craft reliable, maintainable web products—polished frontends, robust APIs, and thoughtful UX.",
    icons: {
        icon: [
            { url: "/favicon.ico" },
            { url: "/Logo-gradient.png", type: "image/png" },
        ],
        apple: [{ url: "/Logo-gradient.png" }],
    },
    openGraph: {
        title: "Arstyn - Build bold products",
